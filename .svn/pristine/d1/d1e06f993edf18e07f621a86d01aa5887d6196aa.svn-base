...
class QueshouGameTcpHandler(GameTcpHandler):
    ...
    def doRoomList(self, userId, gameId):  
        super(QueshouGameTcpHandler, self).doRoomList(userId, gameId) 
 
    @markCmdActionMethod(cmd='user', action='mj_timestamp', scope='game')
    def curTimestemp(self, gameId, userId):
        super(QueshouGameTcpHandler, self).curTimestemp(gameId, userId)
    ...
    def getUserInfoSimple(self, userId, gameId, roomId0, tableId0, clientId):
        super(QueshouGameTcpHandler, self).getUserInfoSimple(userId, gameId, roomId0, tableId0, clientId)
    ...
    def doGetMajiangItem(self, gameId, userId, clientId):
        super(QueshouGameTcpHandler, self).doGetMajiangItem(gameId, userId, clientId)
