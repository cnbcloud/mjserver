...
from luosihu.servers.util.rpc import table_events_remote

class LuosihuTableObserver(MajiangTableObserver):
    def __init__(self, gameId, roomId, tableId):
        super(LuosihuTableObserver, self).__init__(gameId, roomId, tableId)
