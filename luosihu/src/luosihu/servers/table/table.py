...
class LuosihuTableTcpHandler(TableTcpHandler):
    
    def __init__(self):
        super(LuosihuTableTcpHandler, self).__init__()
    ...
    def doTableChat(self, userId, roomId, tableId, seatId, isFace, voiceIdx, chatMsg):
        super(LuosihuTableTcpHandler, self).doTableChat(userId, roomId, tableId, seatId, isFace, voiceIdx, chatMsg)
    ...
    def doTableSmilies(self, userId, roomId, tableId, seatId, smilies, toseat):
        super(LuosihuTableTcpHandler, self).doTableSmilies(userId, roomId, tableId, seatId, smilies, toseat)
    ...
    def doTableSceneLeave(self, userId, roomId, tableId, seatId):
        super(LuosihuTableTcpHandler, self).doTableSceneLeave(userId, roomId, tableId, seatId)
